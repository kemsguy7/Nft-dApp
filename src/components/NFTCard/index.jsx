...
const NFTCard = ({ metadata, mintPrice, tokenId, nextTokenId, mintNFT, owned = false }) => {
  ...
  return (
    <div className='w-full h-full rounded-xl bg-white shadow-md hover:shadow-lg transition-shadow border border-gray-200 overflow-hidden'>
      ...
      <div className='p-4 space-y-3'>
        ...
        <p className='text-sm text-gray-600'>{truncateString(metadata.description, 100)}</p>
